...
import { ChevronLeft,MessageSquareText, Package,WalletMinimal, ChevronRight, Heart, ShoppingCart, MapPin } from "lucide-react";
...
const ProductDetails = ({ productDetails }: { productDetails: any }) => {
  ...
  const fetchFilteredProducts = async() => {
    try{
      ...
      setRecommendedProduct(res?.data?.products)
      ...
      <div className="w-[90%] bg-white lg:w-[80%] mx-auto pt-6 grid grid-cols-1 lg:grid-cols-[28%_44%_28%] gap-6 overflow-hidden">
          ...
          <div className="relative flex items-center gap-2 mt-4 overflow-hidden">
            {productDetails?.images?.length > 4 && (
              <button
                ...
                className="absolute rounded-full left-0 bg-white p-2 shadow-md z-10"
              >
                <ChevronLeft size={24} />
              </button>
            )}
            ...
            {productDetails?.images.length > 4 && (
              <button
                ...
                className="absolute rounded-full right-0 bg-white p-2 shadow-md z-10"
              >
        ...
        <div className="p-4">
          ...
          <div className="w-full flex items-center justify-between">
            <div className="flex gap-2 text-yellow-500 mt-2">
              <Ratings ratings={productDetails?.rating} />
              <Link className="text-blue-500 hover:underline" href="#reviews">
                0 Reviews
              </Link>
            </div>
            <Heart
          ...
          <div className="mt-3">
            ...
            <div className="mt-6">
              ...
              <button
                ...
                ${isInCart ? "cursot-not-allowed" : "cursor-pointer"}
                `}
          ...
          {/* Right column (seller or shop info) */}
      ...
      <div className="w-[90%] lg:w-[80%] mx-auto mt-5">
          <div className="bg-white min-h-[60vh] h-full p-5">
            ...
            <div className="w-[90%] lg:w-[80%] mx-auto">
              <div className="bh-white min-h-[50vh] h-full mt-5 p-5">
              <h3 className="text-lg font-semibold">Ratings & Reviews {productDetails?.title}</h3>
              <p className="text-center pt-14">No Reviews availble yet</p>
          </div>
          </div>
          ...
          <div className="w-[90%] lg:w-[80%] mx-auto">
            ...
            <div className="m-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
              {recommendedProduct?.map((i: any) => (
