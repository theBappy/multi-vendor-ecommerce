...
const Signup = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center pt-10 min-h-screen">
      {/* stepper */}
      <div className="relative flex items-center justify-between md:w-[50%]">
      ...
      {/* steps content */}
      <div className="md:w-[480px] mt-8 p-8 bg-white shadow rounded-lg">
        {activeStep === 1 && (
          <>
            {!showOtp ? (
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input type="tel" placeholder="+101-45-*****" 
                className="w-full p-2 border border-gray-300 outline-0 !rounded mb-1"
                {...register("phone_number", {
                  ...
                  maxLength: {
                    value: 15,
                    message: "Phone number cannot be more than 15 digits"
                  },
                })}
                />
                {errors.phone_number && (
